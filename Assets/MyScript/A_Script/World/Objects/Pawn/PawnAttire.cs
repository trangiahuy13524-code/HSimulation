...
public partial class Pawn
{
    ...
    public bool Wear(DataAttire attireData, ItemClass itemClass, bool debug = false)
    {
        ...
        {
            Debug.LogWarning($"class PawnAttire line 34: Failed to wear item {attireData.itemName} due to body part shape mismatch");
            return false;
        }
    ...
    void CreateAttireSprite(DataAttire attire, ItemClass itemClass, BodyTag bodyTag, bool debug)
    {
        ...
        Transform parent = bodyTag switch
        {
            ...
            BodyTag.Head => headData?.transform,
            BodyTag.Torso => bodyData.transform,
            BodyTag.Legs => bodyData.transform,
            _ => null
        };
